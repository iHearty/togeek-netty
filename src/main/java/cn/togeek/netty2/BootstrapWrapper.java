...
import cn.togeek.netty2.handler.TranspondHandler;
import cn.togeek.netty2.helper.ClientWriteHelper;
...
public class BootstrapWrapper {
   ...
   private static Bootstrap getBootstrap(final boolean forWrite) {
      ...
      bootstrap.group(grp).channel(NioSocketChannel.class).option(
